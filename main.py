...
train_imputer=Knn_imputation(train_good,train_transformable,train_non_transformable)
train=train_imputer.knn_implement()
# val_imputer=Knn_imputation(val_good,val_transformable,val_non_transformable)
# val=train_imputer.knn_implement()
# test_imputer=Knn_imputation(test_good,test_transformable,test_non_transformable)
...
trainx=train.drop(['transported','f_name','l_name'],axis=1)
trainy=train['transported'].astype(int)
valx=val.drop(['transported','f_name','l_name'],axis=1)
